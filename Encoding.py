...
def CompoundEncode(Compound: str, DataDict = ElementDataDict):
    ...
    return ElementalPropertyEncoder(StoichEncoding(ElementEncoding(Compound))[0],StoichEncoding(ElementEncoding(Compound))[1] )
    
# print("Fe10OF19", CompoundEncode("Fe10OF19"))